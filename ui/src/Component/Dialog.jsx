...
function Dialog(props){
    ...
    return(
        <dialog id = 'dialog' ref={modal} onClose={props.onClose}>
            <h2>Add Device</h2>
            <button onClick={handleCloseIcon} className="close-button">X</button>
            <form className="modal-form">
                ...
                <div>
                    ...
                    <input type="text" name="ipAddress" value={formData.ipAddress} onChange={handleChange} required></input>
                </div>
                <div>
                    <label>Device Name</label>
                    <input type="text" name="deviceName" value={formData.deviceName} onChange={handleChange} required></input>
                </div>
                <div>
                ...
                <div>
                    ...
                    <input type="password" name="enablePassword" value={formData.enablePassword} onChange={handleChange} required ></input>
                </div>
